        ...
        <div class="container">
            <div class="handle-box">
                ...
                <el-select v-model="select_cate" placeholder="筛选条件" class="handle-select mr10">
                    <el-option key="0" label="视障用户账号" value="fromName"></el-option>
                </el-select>
            ...
            <el-table :data="tableData" border style="width: 100%" ref="multipleTable">
                ...
                <el-table-column prop="start" label="开始"></el-table-column>
                <el-table-column prop="end" label="结束"></el-table-column>
                <el-table-column prop="count" label="拨打次数"></el-table-column>
                <el-table-column prop="duration" label="总时长" :formatter="durationFormat"></el-table-column>
                <el-table-column prop="mean" label="平均时长" :formatter="meanFormat"></el-table-column>
            </el-table>
    ...
    export default {
        ...
        data() {
            return {
                ...
                selectUrl: "/travelhelper/admin/private/message/blind/count",
                tableData: [],
                total: 10,
        ...
        methods: {
            ...
            getData() {
                ...
                let _this = this;
                this.loading = true;
                this.$axios.post(this.selectUrl + "", queryField).then(res => {
                    this.loading = false;
