    ...
    <div class="table">
        <div class="container">
            ...
            <el-table :data="data" border style="width: 100%" ref="multipleTable">
                <el-table-column prop="username" label="亲属账号">
                </el-table-column>
                <el-table-column prop="nickname" label="亲属昵称">
                </el-table-column>
                <el-table-column prop="blinds" label="视障用户关联" width="120">
                </el-table-column>
...
<script>
    export default {
        data() {
            return {
                selectUrl: '/travelhelper/admin/private/glassesuser/relatives/page',
